    ...
    <View style={styles.container}>
      <View style={styles.card}>
        <View style={styles.iconBadge}>
          <SvgXml xml={mapPinLine} width={20} height={20} />
        </View>
